import { aj as useLocaleHead, ak as useHead, a as useI18n, y as useSeoMetaData } from './chunk-pg-(articles)-D5MrPPlE.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { t } = useI18n();
    useSeoMetaData({
      title: t("common.site.metadata.homepage.title"),
      description: t("common.site.metadata.homepage.description"),
      keywords: t("common.site.metadata.homepage.keywords"),
      relativeUrl: "/"
    });
...
//# sourceMappingURL=default-B9ZyIfnq.mjs.map
